        ...
        <div class="w-1/2 bg-white h-full flex justify-center ">
          <div class="grid h-full items-end" data-te-dropdown-ref>
            ...
            <div
              ...
              class="w-[50vh] absolute z-[1000] float-left m-0 hidden min-w-max list-none overflow-hidden rounded-lg border-none bg-white bg-clip-padding text-left text-base shadow-lg dark:bg-neutral-700 [&[data-te-dropdown-show]]:block">
